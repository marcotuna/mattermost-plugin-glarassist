...
ifeq ($(MM_DEBUG),)
	cd webapp && $(YARN) build:watch
else
	cd webapp && $(YARN) debug:watch
endif
...
ifeq ($(HAS_MM_UTILITIES),)
	...
	cd $(MM_UTILITIES_DIR) && yarn install && yarn babel && node mmjstool/build/index.js i18n extract-webapp --webapp-dir $(PWD)/webapp
endif
endif
